...
local test_dirs = {
    ...
    repo_root .. SEP .. "test" .. SEP .. "sound",
    repo_root .. SEP .. "test" .. SEP .. "options",
}
...
local source_to_tests = {
    ...
    ["src/engine/sound/"]       = {"sound"},
    ["src/engine/verbs/options.lua"] = {"options"},
    ["src/meta/worlds/manor/objects/"]       = {"objects", "sensory"},
    ["src/meta/worlds/manor/rooms/"]         = {"rooms"},
    ["src/meta/worlds/manor/injuries/"]      = {"injuries"},
    ["src/meta/worlds/manor/creatures/"]      = {"creatures", "combat"},
    ["src/meta/worlds/manor/levels/"]         = {"rooms", "integration"},
