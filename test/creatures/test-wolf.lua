...
test("19. territorial is true and territory is 'hallway'", function()
    h.assert_truthy(wolf, "wolf not loaded")
    h.assert_truthy(wolf.behavior, "behavior must exist")
    h.assert_eq(true, wolf.behavior.territorial, "wolf must be territorial")
    h.assert_eq("hallway", wolf.behavior.territory, "territory must be 'hallway'")
end)
