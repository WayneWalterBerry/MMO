...
test("BUG-083: 'could you look for matches' → find, matches", function()
...
test("BUG-093: 'rummage for matches' → search, matches", function()
...
test("BUG-094: 'look for matches' → find, matches (no article)", function()
    local v, n = preprocess.natural_language("look for matches")
    eq("find", v)
    eq("matches", n, "No article to strip, should pass through")
end)
