...
data.IDIOM_TABLE = {
    ...
    -- Issue #433: Greetings route to help
    { pattern = "^hello$",                         replacement = "help" },
    { pattern = "^hi$",                            replacement = "help" },
    { pattern = "^hi there$",                      replacement = "help" },
    { pattern = "^hey$",                           replacement = "help" },
    { pattern = "^hey there$",                     replacement = "help" },
    { pattern = "^greetings$",                     replacement = "help" },
    { pattern = "^sup$",                           replacement = "help" },
    { pattern = "^whats up$",                      replacement = "help" },
    { pattern = "^yo$",                            replacement = "help" },
    -- Issue #439: Frustration phrases route to help
    { pattern = "^i?m confused$",                  replacement = "help" },
    { pattern = "^i am confused$",                 replacement = "help" },
    { pattern = "^this is dumb$",                  replacement = "help" },
    { pattern = "^this is stupid$",                replacement = "help" },
    { pattern = "^i dont get it$",                 replacement = "help" },
    { pattern = "^i don't get it$",                replacement = "help" },
    { pattern = "^dont get it$",                   replacement = "help" },
    { pattern = "^help me$",                       replacement = "help" },
    { pattern = "^i need help$",                   replacement = "help" },
    { pattern = "^i?m stuck$",                     replacement = "help" },
    { pattern = "^i am stuck$",                    replacement = "help" },
    { pattern = "^im lost$",                       replacement = "help" },
    { pattern = "^i am lost$",                     replacement = "help" },
    { pattern = "^what do i do$",                  replacement = "help" },
    { pattern = "^what now$",                      replacement = "help" },
    { pattern = "^now what$",                      replacement = "help" },
    -- Issue #438: MrBeast catchphrases (E-rated worlds only — handler adds Easter egg)
    { pattern = "^subscribe$",                     replacement = "help" },
    { pattern = "^beast mode$",                    replacement = "help" },
    { pattern = "^lets go$",                       replacement = "help" },
    { pattern = "^let's go$",                      replacement = "help" },
    { pattern = "^smash like$",                    replacement = "help" },
    { pattern = "^smash that like$",               replacement = "help" },
    { pattern = "^hit that bell$",                 replacement = "help" },
}
